import { FOOTER_RELATIONSHIP_TYPE, HEADER_RELATIONSHIP_TYPE, HYPERLINK_RELATIONSHIP_TYPE } from './constants';
 ...
 *
 * @param {import('../types').XmlRelationshipElement[]} relationships
 ...
 *
 * @param {import('../types').XmlRelationshipElement[]} existingRelationships
 * @param {import('../types').XmlRelationshipElement[]} newRelationships
 * @returns {import('../types').XmlRelationshipElement[]} merged relationships array
 */
