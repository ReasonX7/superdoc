import { getInitialJSON } from '../docxHelper';
import { carbonCopy } from '../../../utilities/carbonCopy';
import { twipsToInches, resolveOpcTargetPath } from '../../helpers';
import { DEFAULT_LINKED_STYLES } from '../../exporter-docx-defs';
import { drawingNodeHandlerEntity } from './imageImporter';
import { trackChangeNodeHandlerEntity } from './trackChangesImporter';
import { hyperlinkNodeHandlerEntity } from './hyperlinkImporter';
import { runNodeHandlerEntity } from './runNodeImporter';
import { textNodeHandlerEntity } from './textNodeImporter';
import { paragraphNodeHandlerEntity } from './paragraphNodeImporter';
import { sdtNodeHandlerEntity } from './sdtNodeImporter';
import { passthroughNodeHandlerEntity } from './passthroughNodeImporter';
import { lineBreakNodeHandlerEntity } from './lineBreakImporter';
import { bookmarkStartNodeHandlerEntity } from './bookmarkStartImporter';
import { bookmarkEndNodeHandlerEntity } from './bookmarkEndImporter';
import { alternateChoiceHandler } from './alternateChoiceImporter';
import { autoPageHandlerEntity, autoTotalPageCountEntity } from './autoPageNumberImporter';
import { pageReferenceEntity } from './pageReferenceImporter';
import { pictNodeHandlerEntity } from './pictNodeImporter';
import { importCommentData } from './documentCommentsImporter';
import { importFootnoteData, importEndnoteData } from './documentFootnotesImporter';
import { getDefaultStyleDefinition } from '@converter/docx-helpers/index';
import { pruneIgnoredNodes } from './ignoredNodes';
import { tabNodeEntityHandler } from './tabImporter';
import { footnoteReferenceHandlerEntity } from './footnoteReferenceImporter';
import { tableNodeHandlerEntity } from './tableImporter';
import { tableOfContentsHandlerEntity } from './tableOfContentsImporter';
import { indexHandlerEntity, indexEntryHandlerEntity } from './indexImporter';
import { preProcessNodesForFldChar } from '../../field-references';
import { preProcessPageFieldsOnly } from '../../field-references/preProcessPageFieldsOnly';
import { ensureNumberingCache } from './numberingCache';
import { commentRangeStartHandlerEntity, commentRangeEndHandlerEntity } from './commentRangeImporter';
import { permStartHandlerEntity } from './permStartImporter';
import { permEndHandlerEntity } from './permEndImporter';
import { normalizeDuplicateBlockIdentitiesInContent } from './normalizeDuplicateBlockIdentitiesInContent';
import bookmarkStartAttrConfigs from '@converter/v3/handlers/w/bookmark-start/attributes/index';
import bookmarkEndAttrConfigs from '@converter/v3/handlers/w/bookmark-end/attributes/index';
import { translator as wStylesTranslator } from '@converter/v3/handlers/w/styles/index';
import { translator as wNumberingTranslator } from '@converter/v3/handlers/w/numbering/index';
import { baseNumbering } from '@converter/v2/exporter/helpers/base-list.definitions';
import { patchNumberingDefinitions } from './patchNumberingDefinitions';
import { startCollection, drainDiagnostics } from '@converter/v3/handlers/import-diagnostics';
