...
import { config, translator } from './drawing-translator';
import { NodeTranslator } from '../../../node-translator/index';
import { wrapTextInRun } from '../../../../exporter';
...
vi.mock('@converter/v3/handlers/wp/anchor/anchor-translator', () => ({
  translator: anchorTranslatorMock,
}));

vi.mock('@converter/v3/handlers/wp/inline/inline-translator', () => ({
