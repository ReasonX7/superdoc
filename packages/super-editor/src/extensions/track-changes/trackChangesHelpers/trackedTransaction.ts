...
import { replaceAroundStep } from './replaceAroundStep';
import { TrackDeleteMarkName } from '../constants';
import { TrackChangesBasePluginKey } from '../plugins/index';
import { findMark } from '@core/helpers/index';
import { CommentsPluginKey } from '../../comment/comments-plugin';

/**
 * Tracked transaction to track changes.
 * @param {{ tr: import('prosemirror-state').Transaction; state: import('prosemirror-state').EditorState; user: import('@core/types/EditorConfig').User }} params
