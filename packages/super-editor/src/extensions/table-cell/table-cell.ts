 ...
 * @property {import('../table/table').TableMeasurement} [cellWidth] - Cell width
 ...
 * @property {import('../table/table').TableBorders} [borders] - Cell border properties
 * @property {import('../table/table').ShadingProperties} [shading] - Cell shading properties
 * @property {boolean} [noWrap] - Specifies that the cell content should not wrap
 * @property {import('../table/table').TableCellMargins} [cellMargins] - Cell margin properties
...
import { renderCellBorderStyle } from './helpers/renderCellBorderStyle';
 ...
 * @property {import('./helpers/createCellBorders').CellBorders} [borders] - Cell border configuration
