// @ts-check
import { markdownToPmDoc } from './markdown/markdownToPmContent';
 ...
 * @param {((items: import('./catchAllSchema').UnsupportedContentItem[]) => void) | null} [options.onUnsupportedContent] - Callback for unsupported items
