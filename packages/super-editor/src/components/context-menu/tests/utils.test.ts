...
import { createMockEditor, createBeforeEachSetup } from './testHelpers';

// Mock the modules first
vi.mock('../../../core/utilities/clipboardUtils');
vi.mock('../../cursor-helpers', async () => {
  const actual = await vi.importActual('../../cursor-helpers');
  return {
    ...actual,
...
vi.mock('@extensions/track-changes/permission-helpers', () => ({
...
vi.mock('@extensions/table/tableHelpers/isCellSelection', () => ({
...
import { readFromClipboard } from '../../../core/utilities/clipboardUtils';
import { selectionHasNodeOrMark } from '../../cursor-helpers';
import { undoDepth, redoDepth } from 'prosemirror-history';
import { yUndoPluginKey } from 'y-prosemirror';
import { isCellSelection as isCellSelectionMock } from '@extensions/table/tableHelpers/isCellSelection';
import { selectedRect as selectedRectMock } from 'prosemirror-tables';
import {
  collectTrackedChanges,
  collectTrackedChangesForContext,
} from '@extensions/track-changes/permission-helpers';
