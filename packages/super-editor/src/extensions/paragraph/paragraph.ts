import { OxmlNode, Attribute } from '@core/index';
import { Plugin, TextSelection } from 'prosemirror-state';
import { ListHelpers } from '@helpers/list-numbering-helpers';
import { splitBlock } from '@core/commands/splitBlock';
import { removeNumberingProperties, isVisuallyEmptyParagraph } from '@core/commands/removeNumberingProperties';
import { isList } from '@core/commands/list-helpers';
import { findParentNode } from '@helpers/index';
import { InputRule } from '@core/InputRule';
import { toggleList } from '@core/commands/index';
import { restartNumbering } from '@core/commands/restartNumbering';
import { ParagraphNodeView } from './ParagraphNodeView';
import { createNumberingPlugin } from './numberingPlugin';
import { createLeadingCaretPlugin } from './leadingCaretPlugin';
import { createDropcapPlugin } from './dropcapPlugin';
import { shouldSkipNodeView } from '../../utils/headless-helpers';
import { parseAttrs } from './helpers/parseAttrs';
