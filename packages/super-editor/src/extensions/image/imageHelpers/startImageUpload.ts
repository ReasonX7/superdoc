import { findPlaceholder, removeImagePlaceholder, addImagePlaceholder } from './imageRegistrationPlugin';
import { handleImageUpload as handleImageUploadDefault } from './handleImageUpload';
import { processUploadedImage } from './processUploadedImage';
import { buildMediaPath, ensureUniqueFileName } from './fileNameUtils';
