...
import { callOrGet } from '@core/utilities/callOrGet';
import { getExtensionConfigField } from '@core/helpers/getExtensionConfigField';
import { /* TableView */ createTableView } from './TableView';
import { createTable } from './tableHelpers/createTable';
import { createColGroup } from './tableHelpers/createColGroup';
import { deleteTableWhenSelected } from './tableHelpers/deleteTableWhenSelected';
import { normalizeNewTableAttrs } from './tableHelpers/normalizeNewTableAttrs';
import { computeColumnWidths } from './tableHelpers/computeColumnWidths';
import { createTableBorders } from './tableHelpers/createTableBorders';
import {
  isLegacySchemaDefaultBorders,
  convertBordersToOoxmlFormat,
} from '../table-cell/helpers/legacyBorderMigration';
import { isInTable } from '@helpers/isInTable';
import { findParentNode } from '@helpers/findParentNode';
import { TextSelection, Plugin, PluginKey } from 'prosemirror-state';
import { isCellSelection } from './tableHelpers/isCellSelection';
import {
...
import { cellAround } from './tableHelpers/cellAround';
import { cellWrapping } from './tableHelpers/cellWrapping';
import { toggleHeaderRow as toggleHeaderRowCommand } from './tableHelpers/toggleHeaderRow';
import {
  resolveTable,
