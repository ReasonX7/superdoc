//@ts-check
import { chainableEditorState } from './helpers/chainableEditorState';

/**
 * @typedef {import('prosemirror-state').Transaction} Transaction
 * @typedef {import('./commands/types/index').ChainableCommandObject} ChainableCommandObject
 */
...
export class CommandService {
  ...
  /**
   * @param {import('./commands/types/index').CommandServiceOptions} props
   */
  constructor(props) {
   ...
   * @param {import('./commands/types/index').CommandServiceOptions} params for the constructor.
   ...
   *
   * @returns {import('./commands/types/index').EditorCommands} Commands object containing all registered commands
   *
   * @example
  ...
  get commands() {
    ...
    return /** @type {import('./commands/types/index').EditorCommands} */ Object.fromEntries(entries);
  }
   ...
   * @returns {() => import('./commands/types/index').CanObject} Function that creates a can object
   */
  get can() {
   ...
   * @returns {import('./commands/types/index').ChainableCommandObject} The command chain object with all commands and a run() method.
   *
   * @example
   ...
   * @returns {import('./commands/types/index').CanObject} The can object.
   */
  createCan(startTr) {
    ...
    /** @type {Record<string, import('./commands/types/index').CanCommand>} */
    ...
    return /** @type {import('./commands/types/index').CanObject} */ (result);
  }
