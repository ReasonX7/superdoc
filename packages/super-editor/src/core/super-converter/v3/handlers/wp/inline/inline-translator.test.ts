...
import { config, translator } from './inline-translator';
import { NodeTranslator } from '../../../node-translator/index';
import { translateInlineNode } from './helpers/translate-inline-node';
import { handleInlineNode } from './helpers/handle-inline-node';

vi.mock('@converter/v3/handlers/wp/inline/helpers/handle-inline-node', () => ({
  handleInlineNode: vi.fn(),
}));

vi.mock('@converter/v3/handlers/wp/inline/helpers/translate-inline-node', () => ({
