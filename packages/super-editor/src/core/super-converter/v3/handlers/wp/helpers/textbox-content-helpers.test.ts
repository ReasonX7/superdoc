...
} from './textbox-content-helpers';
import { preProcessNodesForFldChar } from '@converter/field-references/preProcessNodesForFldChar';
import { preProcessPageFieldsOnly } from '@converter/field-references/preProcessPageFieldsOnly';
import { resolveRunProperties } from '@converter/styles';
import { translator as rPrTranslator } from '@converter/v3/handlers/w/rpr';

// Mock all dependencies
vi.mock('@converter/field-references/preProcessNodesForFldChar', () => ({
  preProcessNodesForFldChar: vi.fn((nodes) => ({ processedNodes: nodes })),
}));

vi.mock('@converter/field-references/preProcessPageFieldsOnly', () => ({
  preProcessPageFieldsOnly: vi.fn((nodes) => ({ processedNodes: nodes })),
}));

vi.mock('@core/utilities/carbonCopy', () => ({
...
vi.mock('@converter/SuperConverter', () => ({
  SuperConverter: {
