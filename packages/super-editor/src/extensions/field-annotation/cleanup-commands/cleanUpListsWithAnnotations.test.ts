...
import { cleanUpListsWithAnnotations } from './cleanUpListsWithAnnotations';
import * as fieldHelpers from '../fieldAnnotationHelpers/index';
import * as coreHelpers from '@core/helpers/index';

vi.mock('../fieldAnnotationHelpers/index', async () => {
  const actual = await vi.importActual('../fieldAnnotationHelpers/index');
  return {
    ...actual,
...
vi.mock('@core/helpers/index', async () => {
  const actual = await vi.importActual('@core/helpers/index');
  return {
    ...actual,
