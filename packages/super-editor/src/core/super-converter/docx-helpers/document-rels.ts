// @ts-check
import { RELATIONSHIP_TYPES } from './docx-constants';

/** @typedef {import('../types').Editor} Editor */
/** @typedef {import('../types').XmlRelationshipElement} XmlRelationshipElement */
/** @typedef {import('../types').RelationshipType} RelationshipType */
