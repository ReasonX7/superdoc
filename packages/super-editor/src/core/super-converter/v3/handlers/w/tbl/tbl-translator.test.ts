...
// Mock dependencies
vi.mock('@core/super-converter/helpers', () => ({
...
vi.mock('@core/super-converter/v2/exporter/helpers/index', () => ({
  translateChildNodes: vi.fn(() => [{ name: 'w:tr', comment: 'mocked row' }]),
}));

import { translator, _getReferencedTableStyles } from './tbl-translator';
