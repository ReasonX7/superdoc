import { emuToPixels, pixelsToEmu, degreesToRot } from '@converter/helpers';
import { getFallbackImageNameFromDataUri, sanitizeDocxMediaName } from '@converter/helpers/mediaHelpers';
import { prepareTextAnnotation } from '@converter/v3/handlers/w/sdt/helpers/translate-field-annotation';
import { wrapTextInRun } from '@converter/exporter';
import { generateDocxRandomId } from '@core/helpers/index';
import { readImageDimensionsFromDataUri } from '@converter/image-dimensions';
