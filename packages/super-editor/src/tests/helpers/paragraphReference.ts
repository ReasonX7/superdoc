...
import { resolveRunProperties, encodeCSSFromPPr, encodeCSSFromRPr } from '@converter/styles';
import { extractParagraphContext, calculateTabStyle } from '@extensions/tab/helpers/tabDecorations';
