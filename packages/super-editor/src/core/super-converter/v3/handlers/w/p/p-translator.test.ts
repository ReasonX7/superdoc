...
import { translateParagraphNode } from './helpers/translate-paragraph-node';
...
vi.mock('./helpers/legacy-handle-paragraph-node', () => ({
...
vi.mock('./helpers/translate-paragraph-node', () => ({
...
// Import after mocks
import { translator, config } from './p-translator';
import { NodeTranslator } from '@translator';
import { handleParagraphNode } from './helpers/legacy-handle-paragraph-node';
