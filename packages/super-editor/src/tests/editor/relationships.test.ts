...
import { getDocumentRelationshipElements } from '@core/super-converter/docx-helpers/document-rels';
import {
  uploadAndInsertImage,
  replaceSelectionWithImagePlaceholder,
} from '@extensions/image/imageHelpers/startImageUpload';
import { findPlaceholder } from '@extensions/image/imageHelpers/imageRegistrationPlugin';
import { imageBase64 } from './data/imageBase64';
