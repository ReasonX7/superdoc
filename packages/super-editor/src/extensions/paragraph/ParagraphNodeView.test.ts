...
import { resolveParagraphProperties, encodeCSSFromPPr } from '@converter/styles';
import { twipsToPixels } from '@converter/helpers';
import { calculateTabStyle } from '../tab/helpers/tabDecorations';
...
vi.mock('../tab/helpers/tabDecorations', () => ({
