...
import { getParagraphContext } from './paragraphContextCache';
 ...
 * @returns {import('../types').LayoutRequest|null}
 */
 ...
 * @param {import('../types').LayoutRequest} request
 * @param {{ measureText?: (spanId:string, text:string)=>number }} [measurement]
 * @param {import('prosemirror-view').EditorView} [view]
 * @returns {import('../types').LayoutResult}
 */
 ...
 * @param {import('../types').LayoutResult} result
