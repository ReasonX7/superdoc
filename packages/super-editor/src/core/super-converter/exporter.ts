...
import { inchesToTwips, linesToTwips, rgbToHex } from './helpers';
import { DEFAULT_DOCX_DEFS } from './exporter-docx-defs';
import { translateChildNodes } from './v2/exporter/helpers/index';
import { translator as wBrNodeTranslator } from './v3/handlers/w/br/br-translator';
import { translator as wHighlightTranslator } from './v3/handlers/w/highlight/highlight-translator';
import { translator as wTabNodeTranslator } from './v3/handlers/w/tab/tab-translator';
import { translator as wPNodeTranslator } from './v3/handlers/w/p/p-translator';
import { translator as wRNodeTranslator } from './v3/handlers/w/r/r-translator';
import { translator as wTcNodeTranslator } from './v3/handlers/w/tc/tc-translator';
import { translator as wTrNodeTranslator } from './v3/handlers/w/tr/tr-translator';
import { translator as wSdtNodeTranslator } from './v3/handlers/w/sdt/sdt-translator';
import { translator as wTblNodeTranslator } from './v3/handlers/w/tbl/tbl-translator';
import { translator as wUnderlineTranslator } from './v3/handlers/w/u/u-translator';
import { translator as wDrawingNodeTranslator } from './v3/handlers/w/drawing/drawing-translator';
import { translator as wBookmarkStartTranslator } from './v3/handlers/w/bookmark-start/index';
import { translator as wBookmarkEndTranslator } from './v3/handlers/w/bookmark-end/index';
import {
  commentRangeStartTranslator as wCommentRangeStartTranslator,
  commentRangeEndTranslator as wCommentRangeEndTranslator,
} from './v3/handlers/w/commentRange/index';
import { translator as wPermStartTranslator } from './v3/handlers/w/perm-start/index';
import { translator as wPermEndTranslator } from './v3/handlers/w/perm-end/index';
import { translator as sdPageReferenceTranslator } from '@converter/v3/handlers/sd/pageReference';
import { translator as sdCrossReferenceTranslator } from '@converter/v3/handlers/sd/crossReference/crossReference-translator';
import { translator as sdCitationTranslator } from '@converter/v3/handlers/sd/citation/citation-translator';
import { translator as sdBibliographyTranslator } from '@converter/v3/handlers/sd/bibliography/bibliography-translator';
import { translator as sdAuthorityEntryTranslator } from '@converter/v3/handlers/sd/authorityEntry/authorityEntry-translator';
import { translator as sdTableOfAuthoritiesTranslator } from '@converter/v3/handlers/sd/tableOfAuthorities/tableOfAuthorities-translator';
import { translator as sdSequenceFieldTranslator } from '@converter/v3/handlers/sd/sequenceField/sequenceField-translator';
...
import { translator as wFootnoteReferenceTranslator } from './v3/handlers/w/footnoteReference/footnoteReference-translator';
