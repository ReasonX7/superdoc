...
import { removeNumberingProperties } from './removeNumberingProperties';
import { decreaseListIndent } from './decreaseListIndent';
import { updateNumberingProperties } from './changeListLevel';

vi.mock(import('../helpers/findParentNode'), async (importOriginal) => {
...
vi.mock('./decreaseListIndent', () => ({
  decreaseListIndent: vi.fn(),
}));

vi.mock('./changeListLevel', () => ({
