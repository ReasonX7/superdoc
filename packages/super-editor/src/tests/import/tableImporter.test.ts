...
import { tableNodeHandlerEntity } from '@converter/v2/importer/tableImporter';
import { getTestDataByFileName } from '@tests/helpers/helpers';
import { extractParagraphText } from '../helpers/getParagraphText';
