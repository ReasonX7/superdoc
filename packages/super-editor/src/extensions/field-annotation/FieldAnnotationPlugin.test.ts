...
import { FieldAnnotationPlugin } from './FieldAnnotationPlugin';
import { trackFieldAnnotationsDeletion } from './fieldAnnotationHelpers/trackFieldAnnotationsDeletion';
import { getAllFieldAnnotations } from './fieldAnnotationHelpers/getAllFieldAnnotations';

vi.mock('./fieldAnnotationHelpers/trackFieldAnnotationsDeletion', () => ({
  trackFieldAnnotationsDeletion: vi.fn(),
}));

vi.mock('./fieldAnnotationHelpers/getAllFieldAnnotations', () => ({
