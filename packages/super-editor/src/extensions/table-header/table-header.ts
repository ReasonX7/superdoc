...
import { renderCellBorderStyle } from '../table-cell/helpers/renderCellBorderStyle';
 ...
 * @property {import('../table-cell/table-cell').CellBackground} [background] - Cell background color configuration
 * @property {string} [verticalAlign] - Vertical content alignment (top, middle, bottom)
 * @property {import('../table-cell/table-cell').CellMargins} [cellMargins] - Internal cell padding
 * @property {import('../table-cell/helpers/createCellBorders').CellBorders} [borders] - Cell border configuration
 * @property {string} [widthType='auto'] @internal - Internal width type
 * @property {string} [widthUnit='px'] @internal - Internal width unit
 * @property {import('../table-cell/table-cell').TableCellProperties} [tableCellProperties] @internal - Raw OOXML cell properties
 */
