...
import { config, translator } from './totalPageNumber-translator';
import { NodeTranslator } from '../../../node-translator/node-translator';
import { processOutputMarks } from '../../../../exporter';
import { parseMarks } from './../../../../v2/importer/markImporter';

vi.mock('../../../../exporter', () => ({
  processOutputMarks: vi.fn(() => []),
}));

vi.mock('./../../../../v2/importer/markImporter', () => ({
  parseMarks: vi.fn(() => []),
}));
