...
vi.mock('@converter/v2/importer/index', () => ({
  parseMarks: vi.fn(() => []),
...
import { handleParagraphNode } from './legacy-handle-paragraph-node';
import { parseMarks, mergeTextNodes } from '@converter/v2/importer/index';
