...
import { decodeRPrFromMarks, encodeMarksFromRPr, resolveRunProperties } from '@converter/styles';
import {
  calculateResolvedParagraphProperties,
  getResolvedParagraphProperties,
} from '@extensions/paragraph/resolvedPropertiesCache';
import { collectChangedRangesThroughTransactions } from '@utils/rangeUtils';
