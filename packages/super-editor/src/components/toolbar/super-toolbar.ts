...
import { findParentNode } from '@helpers/index';
import { vClickOutside } from '@superdoc/common';
import Toolbar from './Toolbar.vue';
import { getFileOpener, processAndInsertImageFile } from '../../extensions/image/imageHelpers/index';
import { toolbarIcons } from './toolbarIcons';
import { toolbarTexts } from './toolbarTexts';
import { getQuickFormatList } from '@extensions/linked-styles/index';
import { getAvailableColorOptions, makeColorOption, renderColorOptions } from './color-dropdown-helpers';
import { isInTable } from '@helpers/isInTable';
import { useToolbarItem } from '@components/toolbar/use-toolbar-item';
import { yUndoPluginKey } from 'y-prosemirror';
import { isNegatedMark } from './format-negation';
import { collectTrackedChanges, isTrackedChangeActionAllowed } from '@extensions/track-changes/permission-helpers';
import { isList } from '@core/commands/list-helpers';
import { calculateResolvedParagraphProperties } from '@extensions/paragraph/resolvedPropertiesCache';
