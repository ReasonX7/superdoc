...
import { preProcessTextBoxContent } from '@converter/v3/handlers/wp/helpers/textbox-content-helpers';

vi.mock('./parse-inline-styles');
vi.mock('@converter/v2/importer/docxImporter');
vi.mock('@converter/v2/importer/paragraphNodeImporter');
vi.mock('@converter/v3/handlers/wp/helpers/textbox-content-helpers', async (importOriginal) => {
