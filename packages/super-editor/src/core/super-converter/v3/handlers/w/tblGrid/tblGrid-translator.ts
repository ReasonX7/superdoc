...
import { encodeProperties } from '../../utils';
import { translator as gridColTranslator } from '../gridCol';
import { twipsToPixels, pixelsToTwips } from '@converter/helpers';
import { normalizeTwipWidth, resolveFallbackColumnWidthTwips } from './tblGrid-helpers';
