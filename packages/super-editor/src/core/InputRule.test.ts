...
vi.mock('./inputRules/docx-paste/docx-paste', async (importOriginal) => {
...
vi.mock('./inputRules/google-docs-paste/google-docs-paste', () => ({
  handleGoogleDocsHtml: handleGoogleDocsHtmlMock,
}));

vi.mock('./inputRules/html/html-helpers', () => ({
