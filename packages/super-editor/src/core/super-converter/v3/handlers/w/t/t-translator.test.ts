...
import { config, translator } from './t-translator';
import { NodeTranslator } from '@translator';
import { getTextNodeForExport } from '@converter/v3/handlers/w/t/helpers/translate-text-node';
import { translator as wDelTranslator } from '@converter/v3/handlers/w/del/index';
import { translator as wInsTranslator } from '@converter/v3/handlers/w/ins/index';
import { translator as wHyperlinkTranslator } from '@converter/v3/handlers/w/hyperlink/index';

// Mocks
vi.mock('@converter/v3/handlers/w/t/helpers/translate-text-node', () => ({
  getTextNodeForExport: vi.fn(),
}));

vi.mock('@converter/v3/handlers/w/del/index', () => ({
  translator: { decode: vi.fn() },
}));
vi.mock('@converter/v3/handlers/w/ins/index', () => ({
  translator: { decode: vi.fn() },
}));
vi.mock('@converter/v3/handlers/w/hyperlink/index', () => ({
  translator: { decode: vi.fn() },
}));
