...
import { config, translator } from './anchor-translator';
import { NodeTranslator } from '../../../node-translator/index';
import { translateAnchorNode } from './helpers/translate-anchor-node';
import { handleAnchorNode } from './helpers/handle-anchor-node';

vi.mock('@converter/v3/handlers/wp/anchor/helpers/handle-anchor-node', () => ({
  handleAnchorNode: vi.fn(),
}));

vi.mock('@converter/v3/handlers/wp/anchor/helpers/translate-anchor-node', () => ({
