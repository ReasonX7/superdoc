...
} from './v2/importer/docxImporter';
import { normalizeDuplicateBlockIdentitiesInContent } from './v2/importer/normalizeDuplicateBlockIdentitiesInContent';
...
import { deobfuscateFont, getArrayBufferFromUrl, computeCrc32Hex } from './helpers';
import { baseNumbering } from './v2/exporter/helpers/base-list.definitions';
import { DEFAULT_CUSTOM_XML, DEFAULT_DOCX_DEFS } from './exporter-docx-defs';
import {
  getCommentDefinition,
  prepareCommentParaIds,
  prepareCommentsXmlFilesForExport,
} from './v2/exporter/commentsExporter';
import { prepareFootnotesXmlForExport } from './v2/exporter/footnotesExporter';
import { importFootnoteData, importEndnoteData } from './v2/importer/documentFootnotesImporter';
import { DocxHelpers } from './docx-helpers/index';
import { mergeRelationshipElements } from './relationship-helpers';
import { COMMENT_RELATIONSHIP_TYPES } from './constants';
import {
...
} from './export-helpers/strip-orphaned-numbering';
...
class SuperConverter {
   ...
   * @returns {import('./docx-helpers/docx-helpers').DocxHelpers} The DocxHelpers object.
   */
  get docxHelpers() {
    return DocxHelpers;
  }
