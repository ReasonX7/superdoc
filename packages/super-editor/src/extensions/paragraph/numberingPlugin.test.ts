...
import { createNumberingManager } from './NumberingManager';
import { ListHelpers } from '@helpers/list-numbering-helpers';
import { generateOrderedListIndex } from '@helpers/orderedListUtils';
import { docxNumberingHelpers } from '@core/super-converter/v2/importer/listImporter';
...
vi.mock('./NumberingManager', () => ({
  createNumberingManager: vi.fn(),
}));

vi.mock('@helpers/list-numbering-helpers', () => ({
  ListHelpers: {
...
vi.mock('@helpers/orderedListUtils', () => ({
  generateOrderedListIndex: vi.fn(),
}));

vi.mock('@core/super-converter/v2/importer/listImporter', () => ({
