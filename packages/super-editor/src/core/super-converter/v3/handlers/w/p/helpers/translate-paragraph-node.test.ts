...
import { generateParagraphProperties } from './generate-paragraph-properties';

vi.mock('@converter/v2/exporter/helpers/index', () => ({
  translateChildNodes: vi.fn(),
}));

vi.mock('./generate-paragraph-properties', () => ({
  generateParagraphProperties: vi.fn(),
}));

import { translateParagraphNode } from './translate-paragraph-node';
